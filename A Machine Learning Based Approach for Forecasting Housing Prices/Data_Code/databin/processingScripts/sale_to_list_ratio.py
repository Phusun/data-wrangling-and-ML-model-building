...
slr = pd.read_csv('SaleToListRatio_Msa.csv', skiprows=[1])
...
slr.drop(columns=['SizeRank', 'RegionID', 'RegionName', 'RegionType','metro_name', 'state_name', 'in50'], inplace=True)
...
# write to excel file
w = ExcelWriter('Sale to List Ratio.xlsx')
slr.to_excel(w)
w.save()